...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-light sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-dark justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-4">Mewah<sub><i>Caffe</i></sub></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-0 collapse-inner rounded">
                        <a class="collapse-item text-dark" href="">Kopi Hitam</a>
                        <a class="collapse-item" href="">Kopi Susu</a>
                        <a class="collapse-item" href="">Pop ice</a>
                    </div>
                </div>
            </li>
            <!-- Makanan -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-0 d-none d-lg-inline text-gray-500 small mt-0">Selamat Datang</span>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><?= $logo; ?><?= $title; ?></h1>
