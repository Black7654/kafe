...
<head>
    ...
    <link rel="icon" type="img/svg" href="<?= base_url() . 'assets/'; ?>img/logo.png">
...
<body id="page-top">
    ...
    <header class="masthead ">
        <div class="container">
            <div class="masthead-subheading" id="write"></div>
            <div class="masthead-heading" style="font-family: Breeze Personal Use; text-shadow:1px 2px 3px orange;">Mewah Caffe</div>
            <p class=" masthead-subheading">Silahkan Login Untuk menjadi Member Kami</p>
            <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger text-dark" href="<?php echo base_url(); ?>auth/login">
                <span class="faw fas fa-sign-in-alt"></span>&nbsp&nbspSign In
            </a>
        </div>
    </header>
    <!-- Profile-->
    ...
    <section class="page-section bg-light" id="menu">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Pilih Menu yang ingin anda pesan</h3>
            </div>
            <div class="row">
    ...
    <div class="modal modal fade" tabindex="-1" id="portfolioModal2" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="#" type="button" class="btn btn-success"><i class="faw fas fa-shopping-cart mr-1"></i>&nbspPesan</a>
                    <button class="btn btn-danger" data-dismiss="modal" type="button">
                        <i class="fas fa-times mr-1"></i>
                        Close
                    </button>
    ...
    <div class="modal modal fade" tabindex="-1" id="portfolioModal3" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>auth/login" type="button" class="btn btn-success"><i class="fas fa-shopping-cart mr-1"></i>&nbspPesan</a>
                    <button class="btn btn-danger" data-dismiss="modal" type="button">
                        <i class="fas fa-times mr-1"></i>
                        Close
                    </button>
    ...
    <!-- Typed JS -->
    <script src="<?php echo base_url() . 'assets/'; ?>landing/js/typed.js"></script>
